# M01_installer-Modul für MINTutil
...
$script:AppsDataPath = Join-Path -Path $PSScriptRoot -ChildPath "../../data/M01_installer/apps.json"
$script:OutputPath = Join-Path -Path $PSScriptRoot -ChildPath "../../config/M01_installer/output.json"
...
function Initialize-M01_installer {
    param(
    ...
    try {
        ...
        Write-Host "M01_installer-Modul initialisiert"
        return $true
    } catch {
        Write-Error "Fehler bei der Initialisierung des M01_installer-Moduls: $_"
        return $false
    }
}
...
function Register-EventHandlers {
    try {
        ...
        Write-Host "Event-Handler für M01_installer-Modul registriert"
    } catch {
...
Export-ModuleMember -Function Initialize-M01_installer