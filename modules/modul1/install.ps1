...
$script:AppsDataPath = Join-Path -Path $PSScriptRoot -ChildPath "../../data/modul1/apps.json"
$script:OutputPath = Join-Path -Path $PSScriptRoot -ChildPath "../../config/modul1/output.json"
