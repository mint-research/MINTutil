...
try {
    ...
    Write-ColorOutput "Project documentation: $projectMissing files missing out of $projectTotal required" -ForegroundColor $projectColor
    ...
    foreach ($result in $moduleResults) {
        ...
        Write-ColorOutput "$moduleName documentation: $moduleMissing files missing out of $moduleTotal required" -ForegroundColor $moduleColor
    }
