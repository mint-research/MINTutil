...
$script:CacheDataPath = Join-Path -Path $PSScriptRoot -ChildPath "../../data/SystemInfo/cache.json"
$script:HistoryDataPath = Join-Path -Path $PSScriptRoot -ChildPath "../../data/SystemInfo/history.json"
$script:ReportsPath = Join-Path -Path $PSScriptRoot -ChildPath "../../data/SystemInfo/reports"
$script:DisplayConfigPath = Join-Path -Path $PSScriptRoot -ChildPath "../../config/SystemInfo/display.json"
...
function Initialize-SystemInfo {
    ...
    try {
        ...
        Write-Host "SystemInfo-Modul initialisiert"
        return $true
    } catch {
        Write-Error "Fehler bei der Initialisierung des SystemInfo-Moduls: $_"
        return $false
    }
}
...
function Register-EventHandlers {
    try {
        ...
        Write-Host "Event-Handler für SystemInfo-Modul registriert"
    } catch {
...
Export-ModuleMember -Function Initialize-SystemInfo